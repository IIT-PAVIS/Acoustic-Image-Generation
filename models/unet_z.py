...
class UNetAc(object):
    ...
    def _build_network(self, inputs, mean2, std2, is_training=True, keep_prob=0.5, weight_decay=1e-6, scope='UNetAcoustic'):
        """
    ...
    def _build_model(self, acoustic_images, mean2, std2):
        """
        ...
        mean, std, dualcam_net_output, dualcam_net_end_points = self._build_network(acoustic_images, mean2, std2, is_training=is_training,
                                                                             scope=self.scope)
