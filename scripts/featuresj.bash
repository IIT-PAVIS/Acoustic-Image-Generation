...
cd ..
#/data/checkpoints/variationaljointtwozero /data/checkpoints/variationaljointtwoae
EXP=/data/checkpoints/variationaljoint10-4lessvar
MOD2=(Video Ac AcTrue Audio)
